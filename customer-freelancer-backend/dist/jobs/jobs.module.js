...
JobsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([job_entity_1.Job, freelancer_entity_1.Freelancer, job_user_entity_1.JobUser, customer_entity_1.Customer]), job_skill_module_1.JobSkillModule],
