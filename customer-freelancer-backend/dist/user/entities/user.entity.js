...
__decorate([
    (0, typeorm_1.OneToMany)(type => customer_entity_1.Customer, customer => customer.user, { cascade: true }),
    __metadata("design:type", customer_entity_1.Customer)
], User.prototype, "customer", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(type => freelancer_entity_1.Freelancer, freelancer => freelancer.user, { cascade: true }),
    __metadata("design:type", freelancer_entity_1.Freelancer)
], User.prototype, "freelancer", void 0);
User = __decorate([
    (0, typeorm_1.Entity)()
], User);
exports.User = User;
